...
<form class="layui-form">
    <div class="layui-input-inline" style="width: 250px;">
        <input type="text" name="name" id="name" placeholder="请输入图片名称" class="layui-input" autocomplete="off">
    </div>
...
<script>
    ...
    url_list = '${ctx}/mall/banner/list';
    url_add = '${ctx}/mall/banner/add';
    url_update = '${ctx}/mall/banner/update';
    url_del = '${ctx}/mall/banner/del';
    url_delAll = '${ctx}/mall/banner/delAll';
