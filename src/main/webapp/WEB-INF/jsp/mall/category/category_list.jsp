...
<script type="text/html" id="tool">
    ...
    {{#  if(d.parentId == 0){ }}
    <a lay-event="list" title="子类目" href="javascript:"> <i class="layui-icon">&#xe62d;</i></a>
    {{# } }}
...
<script>
    ...
    url_add = '${ctx}/mall/category/add';
    url_update = '${ctx}/mall/category/update';
    url_del = '${ctx}/mall/category/del';
    url_delAll = '${ctx}/mall/category/delAll';
    ...
    table = laytable.render({
        ...
        cols: [[ //表头
            ...
            {field: 'logo', title: '类目图标'},
            {field: 'img', title: '类目图片'},
