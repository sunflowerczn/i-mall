...
<form class="layui-form" id="data-from">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" required lay-verify="required"
                   placeholder="请输入商品分类名称" class="layui-input" autocomplete="off" value="${category.name}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="logo" required lay-verify="required"
                   placeholder="请输入图标样式" class="layui-input" autocomplete="off" value="${category.logo}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="sort" required lay-verify="required|number"
                   placeholder="请输入数字" class="layui-input" autocomplete="off" value="${category.sort}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <img id="img" src="${category.img}" width="200px" onerror="this.src='${ctx}/images/no.png'"/>
            <input type="hidden" name="img" id="input-img" lay-verify="requiredFile" value="${category.img}">
        </div>
    </div>
    <hr>
