        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 60%">
                        <input type="text" name="name" required lay-verify="required"
                               placeholder="请输入商品名称" class="layui-input" autocomplete="off" value="${goods.name}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input id="selectCategory" type="text" readonly
                               placeholder="请输入商品分类" class="layui-input" value="${category.name}" lay-verify="required">
                        <input id="categoryId" name="categoryId" type="hidden" value="${goods.categoryId}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 80%">
                        <input type="text" name="introduce" required lay-verify="required"
                               placeholder="请输入商品简介" class="layui-input" autocomplete="off" value="${goods.introduce}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="price" required lay-verify="required|number"
                               placeholder="请输入数字" class="layui-input" autocomplete="off" value="${goods.price}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="unit" required lay-verify="required"
                               placeholder="请输入价格单位" class="layui-input" autocomplete="off" value="${goods.unit}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="stock" required lay-verify="required"
                               placeholder="请输入库存数量" class="layui-input" autocomplete="off" value="${goods.stock}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <img id="img" src="${goods.img}" width="200px"/>
                        <input type="hidden" name="img" id="input-img" lay-verify="requiredFile" value="${goods.img}">
                    </div>
                </div>
                <hr>
            ...
            <div class="layui-tab-item">
                <img id="detail-img" src="${goods.detailImg}" width="200px"/>
                <input type="hidden" name="detailImg" id="input-detail-img" lay-verify="requiredFile" value="${goods.detailImg}">
                <hr>
            ...
            <div class="layui-tab-item">
                <textarea id="editor_id" name="detail" style="width:100%;height: 350px;">${goods.detail}</textarea>
            </div>
